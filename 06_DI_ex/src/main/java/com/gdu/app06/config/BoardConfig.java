...
public class BoardConfig {
  ...
  @Bean
  public BoardDto boardDto1() { // <bean calss="BoardDto" id="boardDto1" />
    return new BoardDto(1, "제목1", "작성자1");
  }
  
  @Bean
  public BoardDto boardDto2() { // <bean calss="BoardDto" id="boardDto2" />
    return new BoardDto(2, "제목2", "작성자2");
  }
  
  @Bean
  public BoardDto boardDto3() { // <bean calss="BoardDto" id="boardDto3" />
