...
public class MyController04 {
  ...
  public String main2(SessionStatus sessionStatus) {
    ...
    sessionStatus.setComplete(); // spring 지원 (spring사용할거면 이걸많이사용)
   ...
   */
  @GetMapping("/article/confirm.do")
  public String confirm2(@SessionAttribute("title") String title, HttpServletRequest request) { // session에 저장된 "title" 속성을 String title에 저장한다.
    System.out.println(title);
    System.out.println(request.getContextPath());
    return "index";
  }
