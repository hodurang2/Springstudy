...
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 'user2@naver.com', STANDARD_HASH('1111', 'SHA256'), '사용자2', 'F', '01022222222', '22222', '디지털로', '가산동', '102동 102호', 0, TO_DATE('20230801', 'YYYYMMDD'), TO_DATE('20220101', 'YYYYMMDD'));
INSERT INTO USER_T VALUES(USER_SEQ.NEXTVAL, 'user3@naver.com', STANDARD_HASH('1111', 'SHA256'), '사용자3', 'NO', '01033333333', '33333', '디지털로', '가산동', '103동 103호', 0, TO_DATE('20230601', 'YYYYMMDD'), TO_DATE('20220101', 'YYYYMMDD'));
...
-- 3. 휴면 처리 할 때 (12개월 이상 로그인 이력이 없다. OR 로그인 이력이 전혀 없는 사용자 중에서 가입일이 12개월 이상 지났다.)
...
-- 4. 휴면 복원 할 때 
-- INACTIVE_USER_T -> USER_T에추가 -> INACTIVE_USER_T에서 삭제
INSERT INTO USER_T
(
