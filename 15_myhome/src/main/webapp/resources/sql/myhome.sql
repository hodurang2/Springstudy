...
CREATE TABLE BLOG_T (
    ...
    USER_NO     NUMBER             NOT NULL  ,  -- 작성자 번호(NULL인 경우 ON DELETE SET NULL처리가 가능하고, NOT NULL인 경우는 ON DELETE CASCADE처리 상황에 따라 옵션 선택)
    ...
    CONSTRAINT FK_USER_BLOG FOREIGN KEY(USER_NO) REFERENCES USER_T(USER_NO) ON DELETE CASCADE  -- 작성자가 삭제되면 블로그도 함께 삭제
);

-- 블로그 댓글(계층형-N차, 댓글 작성 가능/대댓글 작성 불가능)
...
INSERT INTO FREE_T VALUES (FREE_SEQ.NEXTVAL, 'user3@naver.com', '내용4', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
...
INSERT INTO FREE_T VALUES (FREE_SEQ.NEXTVAL, 'user3@naver.com', '내용10', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
...
INSERT INTO FREE_T VALUES (FREE_SEQ.NEXTVAL, 'user2@naver.com', '내용21', SYSTIMESTAMP, 1, 0, FREE_SEQ.CURRVAL, 0);
COMMIT;

-- 쿼리 테스트

-- 1. 목록 (최근에 작성한 목록 5 ~ 10개)
