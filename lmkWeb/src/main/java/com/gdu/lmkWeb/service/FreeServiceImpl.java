package com.gdu.lmkWeb.service;
...
import com.gdu.lmkWeb.dao.FreeMapper;
import com.gdu.lmkWeb.dto.FreeDto;
import com.gdu.lmkWeb.util.MyPageUtils;
import com.gdu.lmkWeb.util.MySecurityUtils;
...
public class FreeServiceImpl implements FreeService{
  ...
  public int addFree(HttpServletRequest request) {
    ...
    String contetns = mySecurityUtils.preventXSS(request.getParameter("contents"));
  ...
  @Override
  public void loadSerachList(HttpServletRequest request, Model model) {
